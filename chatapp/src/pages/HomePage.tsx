    ...
    <LampContainer>
      ...
      <div>
        ...
        <Link to="/signin">
            <Button
        variant={"ghost"}
            className="rounded-full border border-neutral-800 focus:ring-2 focus:ring-teal-500  w-full relative z-10 mt-4  bg-neutral-350 placeholder:text-white text-white"
        >Log in</Button>
        </Link>
        <Link to="/signup">
            <Button
